...
<body onload="gallery()" oncontextmenu="return false;">
    <div class="container" id="container-gallery">
        ...
        <div class="gallery-filter">
            ...
            <a href="gallery-recent.php" id="recent-g" style="background: red;">Recent</a>
        ...
        <div class="gallery-recent" id="gallery-recent">
            <div class="recent-images"><img src="assets/images/events16.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: .2s;"><img src="assets/images/events15.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: .4s;"><img src="assets/images/events14.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: .6s;"><img src="assets/images/events13.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: .8s;"><img src="assets/images/events12.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 1s;"><img src="assets/images/events11.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 1.2s;"><img src="assets/images/events10.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 1.4s;"><img src="assets/images/events9.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 1.6s;"><img src="assets/images/events8.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 1.8s;"><img src="assets/images/events7.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 2s;"><img src="assets/images/events6.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 2.2s;"><img src="assets/images/events5.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 2.4s;"><img src="assets/images/events4.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 2.6s;"><img src="assets/images/events3.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 2.8s;"><img src="assets/images/events2.JPG" alt="Event image"></div>
            <div class="recent-images" style="animation-delay: 3s;"><img src="assets/images/events1.JPG" alt="Event image"></div>
        </div>
